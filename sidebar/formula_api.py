...
from streamlit_extras.streaming_text import typewriter
...
def show_formula_api():
    ...
    if st.button("Execute Request"):
        if not query:
            st.warning("Please enter a topic path.")
            return
